...
public class MainActivity extends AppCompatActivity {
    ...
    private AdaptadorElementos adaptador;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datos.add("Recoger a Paco");
        datos.add("Ir a comprar");
        datos.add("Barrer la casa");
        datos.add("Terminar ejercicios PMDM");
        ...
        // Creamos un adaptaor
        adaptador = new AdaptadorElementos(datos);

        // Asignamos el adaptador a nuestro ListView
        listado.setAdapter(adaptador);

        // Establecemos el LayoutManager
        ...
        adaptador.setItemClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                int position = listado.getChildAdapterPosition(v);
